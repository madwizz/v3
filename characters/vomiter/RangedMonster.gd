...
onready var anim_vomiter = $Graphics/Vomiter/AnimationPlayer
...
func set_state_idle():
	...
	anim_vomiter.play("idle")

func set_state_chase():
	cur_state = STATES.CHASE
	anim_vomiter.play("move", 0.2)
...
func start_attack():
	can_attack = false
	anim_vomiter.play("attack", -1, attack_speed)
	attack_timer.start()
